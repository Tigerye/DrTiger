...
def help():
    print("Usage: python doc_retriever_en.py /data/yechen/bert/wiki.en.section.txt /data/yechen/bert/drtiger/bm25_en_section")
...
#         reader_cmd = 'python /home/yechen/Workspace/bert/run_squad.py   --vocab_file=/data/yechen/bert/uncased_L-24_H-1024_A-16/vocab.txt   --bert_config_file=/data/yechen/bert/uncased_L-24_H-1024_A-16/bert_config.json   --init_checkpoint=/data/yechen/bert/uncased_L-24_H-1024_A-16/bert_model.ckpt   --do_train=False   --train_file=/data/yechen/squad/train-v2.0.json   --do_predict=True   --predict_file=/data/yechen/bert/drtiger/retrieved_en.json   --train_batch_size=8   --learning_rate=3e-5   --num_train_epochs=2.0   --max_seq_length=512   --doc_stride=128   --output_dir=/data/yechen/squad/squad_2.0_large_1-256/   --version_2_with_negative=True   --null_score_diff_threshold=-4.251452803611755'
        reader_cmd = 'python /home/yechen/Workspace/bert/run_squad.py   --vocab_file=/data/yechen/bert/uuncased_L-12_H-768_A-12/vocab.txt   --bert_config_file=/data/yechen/bert/uncased_L-12_H-768_A-12/bert_config.json   --init_checkpoint=/data/yechen/bert/uncased_L-12_H-768_A-12/bert_model.ckpt   --do_train=False   --train_file=/data/yechen/squad/train-v2.0.json   --do_predict=True   --predict_file=/data/yechen/bert/drtiger/retrieved_en.json   --train_batch_size=8   --learning_rate=3e-5   --num_train_epochs=2.0   --max_seq_length=384   --doc_stride=128   --output_dir=/data/yechen/squad/squad_2.0_base_6data_seq384/   --version_2_with_negative=True   --null_score_diff_threshold=-0.5864834785461426'
...
#         with open('/data/yechen/squad/squad_2.0_large_1-256/nbest_predictions.json','r') as f:
        with open('/data/yechen/squad/squad_2.0_base_6data_seq384/nbest_predictions.json','r') as f:
