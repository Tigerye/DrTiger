...
#         reader_cmd = 'python /home/yechen/Workspace/bert/run_squad.py   --vocab_file=/data/yechen/bert/chinese_L-12_H-768_A-12/vocab.txt   --bert_config_file=/data/yechen/bert/chinese_L-12_H-768_A-12/bert_config.json   --init_checkpoint=/data/yechen/bert/chinese_L-12_H-768_A-12/bert_model.ckpt   --do_train=False   --train_file=/data/yechen/squad/WebQA.v1.0/webqa_squad_train.json   --do_predict=True   --predict_file=/data/yechen/bert/drtiger/retrieved_zh.json   --train_batch_size=8   --learning_rate=3e-5   --num_train_epochs=2.0   --max_seq_length=384   --doc_stride=128   --output_dir=' + model_path
        reader_cmd = 'python /home/yechen/Workspace/DrTiger/run_squad_v2.py   --vocab_file=/data/yechen/bert/chinese_L-24_H-1024_A-16/vocab.txt   --bert_config_file=/data/yechen/bert/chinese_L-24_H-1024_A-16/bert_config.json   --init_checkpoint=/data/yechen/bert/chinese_L-24_H-1024_A-16/bert_model.ckpt   --do_train=False   --train_file=/data/yechen/squad/WebQA.v1.0/webqa_squad_train.json   --do_predict=True   --predict_file=/data/yechen/bert/drtiger/retrieved_zh.json   --train_batch_size=8   --learning_rate=3e-5   --num_train_epochs=2.0   --max_seq_length=384   --doc_stride=128   --output_dir=' + model_path + '   --version_2_with_negative=True   --null_score_diff_threshold=-0.03782176971435547'
