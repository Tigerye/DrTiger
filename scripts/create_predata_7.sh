...
infile=/data/yechen/bert/news.zh.2018.pre.txt
echo "create predata from ${infile} to tf_examples_news2018_seq512.tfrecord ..."

python /home/yechen/Workspace/DrTiger/create_pretraining_data.py \
  --input_file=${infile} \
  --output_file=$DATA_DIR/seq512/tf_examples_news2018_seq512.tfrecord \
  --vocab_file=$BERT_BASE_DIR/vocab.txt \
  --do_lower_case=True \
  --max_seq_length=512 \
  --max_predictions_per_seq=80 \
